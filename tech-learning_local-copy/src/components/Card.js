  ...
  return (
    <>
      {courses.map((course) => (
        <Col
          key={course.id}
          className="d-flex justify-content-center card-column">
          <Card className="cours-card d-flex justify-content-center align-items-center py-3">
            ...
            <Card.Body className="w-100 d-flex align-items-center flex-column">
              <Card.Title className="fw-bold w-100 fs-3 text-ceter">
                {course.title}
              </Card.Title>
