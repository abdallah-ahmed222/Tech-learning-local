        ...
        <Form className="d-flex justify-content-between align-items-center flex-column flex-lg-row">
          ...
          <div className="summry w-25">
            ...
            <div className="text-white">
              ...
              <p className="border-bottom m-0 d-flex align-items-center justify-content-between">
                <span>Discounts</span> <span> ${0}</span>
              </p>
              <p>total is ${total}</p>
              <Button
                type="submit"
                className="app-nav__btn m-0"
                onClick={(eve) => setInLocal(eve)}>
                Proceed
              </Button>
